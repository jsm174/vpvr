...
// https://github.com/reactos/reactos/blob/master/sdk/include/host/typedefs.h
...
const GUID GUID_NULL = {0x00000000L,
                        0x0000,
                        0x0000,
...
DWORD WINAPI DECLSPEC_HOTPATCH GetModuleFileName(HMODULE module, LPSTR filename,
                                                 DWORD size);
...
class PoleStorage : public IStorage {
 public:
  ...
  HRESULT OpenStream(LPCOLESTR pwcsName, void* reserved1, DWORD grfMode,
    ...
    char szName[1024];
    WideToUtf(pwcsName, szName, 1024);
